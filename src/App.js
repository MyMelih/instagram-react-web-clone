...
function App() {
  ...
  useEffect(() => {
    ...
    imageSlider()
    //* setInterval ile her 1 saniye başına resim değiştirecez. 
    let interval = setInterval(imageSlider, 3000)
    return () => {
      //* component destroy olduğunda clearInterval sayesinde temizlenecek.
    ...
    <div className="h-full f-full flex flex-wrap overflow-auto items-center  gap-x-8 justify-center">
      ...
      <div className="hidden md:block w-[380px] h-[581px] bg-logo-pattern relative bg-[length:468.32px_634.15px] bg-[top_left_-46px]">
        <div className="w-[250px] h-[538px] absolute top-[27px] right-[18px]" ref={ref}>
          ...
          <img className="w-full h-full absolute top-0 left-0 opacity-0 transition-opacity duration-1000 ease-linear" src="https://www.instagram.com/static/images/homepage/screenshots/screenshot4-2x.png/8e9224a71939.png" alt="" />
        </div>
      </div>
      ...
      <div className="w-[350px] grid gab-y-3">
        <div className="bg-white border px-[40px] pt-10 pb-6">
          ...
          <form className="grid gap-y-1.5">
            ...
            <button type="submit" disabled={!enable} className="h-[30px] rounded mt-1 bg-brand font-medium text-white text-sm disabled:opacity-50">Log In</button>
