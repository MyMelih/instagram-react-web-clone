...
export default function Input({ label, type = 'text', ...props }) {
    ...
    return (
        <label className="block relative flex bg-zinc-50 border rounded-sm focus-within:border-gray-400">
            ...
            <small className="absolute top-1/2 left-[9px] -translate-y-1/2 text-sx text-gray-400 cursor-text pointer-events-none transition-all peer-valid:text-[10px] peer-valid:top-2.5">{label}</small>
